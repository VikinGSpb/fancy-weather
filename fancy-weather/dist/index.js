...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"changeDegree\", function() { return changeDegree; });\nfunction fToC(temp) {\n  return Math.round(5 / 9 * (temp - 32));\n}\n\nfunction cToF(temp) {\n  return Math.round(9 / 5 * temp + 32);\n}\n\nfunction changeDegree() {\n  var fDeg = document.querySelector('#F');\n  var cDeg = document.querySelector('#C');\n  var nextDay1TempSpan = document.querySelector('#nextDay1>div>span');\n  var nextDay2TempSpan = document.querySelector('#nextDay2>div>span');\n  var nextDay3TempSpan = document.querySelector('#nextDay3>div>span');\n  var appTempSpan = document.querySelectorAll('.today-weather__other>span')[1];\n  var tempSpan = document.querySelector('.today-weather__forecast>span');\n  fDeg.addEventListener('click', function () {\n    if (fDeg.className === 'inactive') {\n      cDeg.className = 'inactive';\n      fDeg.className = 'active';\n      nextDay1TempSpan.innerHTML = \"\".concat(cToF(parseInt(nextDay1TempSpan.innerHTML)), \"F\");\n      nextDay2TempSpan.innerHTML = \"\".concat(cToF(parseInt(nextDay2TempSpan.innerHTML)), \"F\");\n      nextDay3TempSpan.innerHTML = \"\".concat(cToF(parseInt(nextDay3TempSpan.innerHTML)), \"F\");\n      appTempSpan.innerHTML = \"\".concat(cToF(parseInt(appTempSpan.innerHTML)), \"F\");\n      tempSpan.innerHTML = \"\".concat(cToF(parseInt(tempSpan.innerHTML)), \"F\");\n      localStorage.setItem('deg', 'F');\n    }\n  });\n  cDeg.addEventListener('click', function () {\n    if (cDeg.className === 'inactive') {\n      fDeg.className = 'inactive';\n      cDeg.className = 'active';\n      nextDay1TempSpan.innerHTML = \"\".concat(fToC(parseInt(nextDay1TempSpan.innerHTML)), \"&#176;\");\n      nextDay2TempSpan.innerHTML = \"\".concat(fToC(parseInt(nextDay2TempSpan.innerHTML)), \"&#176;\");\n      nextDay3TempSpan.innerHTML = \"\".concat(fToC(parseInt(nextDay3TempSpan.innerHTML)), \"&#176;\");\n      appTempSpan.innerHTML = \"\".concat(fToC(parseInt(appTempSpan.innerHTML)), \"&#176;\");\n      tempSpan.innerHTML = \"\".concat(fToC(parseInt(tempSpan.innerHTML)), \"&#176;\");\n      localStorage.setItem('deg', 'C');\n    }\n  });\n}\n\n//# sourceURL=webpack:///./src/components/functions/changeDegree.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getLinkToImage\", function() { return getLinkToImage; });\nvar Seasons = {\n  winter: ['January', 'Январь', 'Студзень', 'February', 'Февраль', 'Люты', 'December', 'Декабрь', 'Снежань'],\n  spring: ['March', 'Март', 'Сакавік', 'April', 'Апрель', 'Красавік', 'May', 'Май', 'Май'],\n  summer: ['June', 'Июнь', 'Чэрвень', 'July', 'Июль', 'Ліпень', 'August', 'Август', 'Жнівень'],\n  autumn: ['September', 'Сентябрь', 'Верасень', 'October', 'Октябрь', 'Кастрычнік', 'November', 'Ноябрь', 'Лістапад']\n};\nvar DayTime = {\n  morning: [6, 7, 8, 9, 10, 11],\n  day: [12, 13, 14, 15, 16, 17],\n  evening: [18, 19, 20, 21, 22, 23],\n  night: [0, 1, 2, 3, 4, 5]\n};\nfunction getLinkToImage() {\n  var width, height, body, city, todayWeatherDate, month, season, key, i, summary, time, dayT, _key, _i, url, response, data, image, link;\n\n  return regeneratorRuntime.async(function getLinkToImage$(_context) {\n    while (1) {\n      switch (_context.prev = _context.next) {\n        case 0:\n          width = screen.width.toString();\n          height = screen.height.toString();\n          body = document.querySelector('body');\n          city = document.querySelector('.today-weather__place').innerHTML;\n          todayWeatherDate = document.querySelector('.today-weather__date');\n          month = todayWeatherDate.innerHTML.slice(3, todayWeatherDate.innerHTML.indexOf(' ', 4)).trim();\n\n          for (key in Seasons) {\n            for (i = 0; i < 9; i += 1) {\n              if (Seasons[key][i] === month) season = key;\n            }\n          }\n\n          summary = document.querySelector('.today-weather__other>p').innerHTML;\n          time = document.querySelector('.today-weather__date').innerHTML.slice(document.querySelector('.today-weather__date').innerHTML.lastIndexOf(' '));\n\n          for (_key in DayTime) {\n            for (_i = 0; _i < 6; _i += 1) {\n              if (DayTime[_key][_i] === Number(time.slice(0, 3))) dayT = _key;\n            }\n          }\n\n          url = \"https://api.unsplash.com/photos/random?orientation=landscape&per_page=1&query=\".concat(season, \",\").concat(city, \",\").concat(dayT, \",\").concat(summary, \"\\n  &client_id=a2840b831d7df553cc4c7c1492e8602cbd21b24a89cb2050aaf67407e892be30\");\n          _context.prev = 11;\n          _context.next = 14;\n          return regeneratorRuntime.awrap(fetch(url));\n\n        case 14:\n          response = _context.sent;\n          _context.next = 17;\n          return regeneratorRuntime.awrap(response.json());\n\n        case 17:\n          data = _context.sent;\n          image = document.createElement('img');\n          image.crossOrigin = 'Anonymous';\n          link = \"\".concat(data.urls.raw, \"&w=\").concat(width, \"&h=\").concat(height);\n          image.setAttribute('src', link);\n\n          image.onload = function () {\n            body.style.background = \"url(\".concat(link, \") no-repeat\");\n            body.style.backgroundSize = 'cover';\n          };\n\n          image.onerror = function () {\n            throw new Error('Data Error');\n          };\n\n          _context.next = 29;\n          break;\n\n        case 26:\n          _context.prev = 26;\n          _context.t0 = _context[\"catch\"](11);\n          console.error(_context.t0);\n\n        case 29:\n        case \"end\":\n          return _context.stop();\n      }\n    }\n  }, null, null, [[11, 26]]);\n}\n\n//# sourceURL=webpack:///./src/components/functions/getLinkToImage.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getWeather\", function() { return getWeather; });\nfunction fToC(temp) {\n  return Math.round(5 / 9 * (temp - 32));\n}\n\nfunction windToMS(windKH) {\n  return (1000 * windKH / 3600).toFixed(1);\n}\n\nfunction getWeather(lat, _long) {\n  var tempSpan, summaryWeather, summaryWeatherP, appTempSpan, windSpan, humiditySpan, todayWeatherDate, nextDay1Span, nextDay2Span, nextDay3Span, nextDay1TempSpan, nextDay2TempSpan, nextDay3TempSpan, todayWeatherIconElement, nextDay1WeatherIconElement, nextDay2WeatherIconElement, nextDay3WeatherIconElement, url, response, data, WeatherP, tempF, tempC, appTempF, appTempC, windSpeed, humidity, todayWeatherIcon, nextDay1WeatherIcon, nextDay2WeatherIcon, nextDay3WeatherIcon, nextDay1Temp, nextDay2Temp, nextDay3Temp, today, nextDay1, nextDay2, nextDay3, currTimeStr, currTime, nextWeekDay1, nextWeekDay2, nextWeekDay3;\n  return regeneratorRuntime.async(function getWeather$(_context) {\n    while (1) {\n      switch (_context.prev = _context.next) {\n        case 0:\n          tempSpan = document.querySelector('.today-weather__forecast>span');\n          summaryWeather = document.querySelectorAll('.today-weather__other>span:not(.not)');\n          summaryWeatherP = document.querySelector('.today-weather__other>p');\n          appTempSpan = summaryWeather[0];\n          windSpan = summaryWeather[1];\n          humiditySpan = summaryWeather[2];\n          todayWeatherDate = document.querySelector('.today-weather__date');\n          nextDay1Span = document.querySelector('#nextDay1>span');\n          nextDay2Span = document.querySelector('#nextDay2>span');\n          nextDay3Span = document.querySelector('#nextDay3>span');\n          nextDay1TempSpan = document.querySelector('#nextDay1>div>span');\n          nextDay2TempSpan = document.querySelector('#nextDay2>div>span');\n          nextDay3TempSpan = document.querySelector('#nextDay3>div>span');\n          todayWeatherIconElement = document.querySelector('.today-weather__icon');\n          nextDay1WeatherIconElement = document.querySelector('#nextDay1>div>div');\n          nextDay2WeatherIconElement = document.querySelector('#nextDay2>div>div');\n          nextDay3WeatherIconElement = document.querySelector('#nextDay3>div>div');\n          url = 'https://cors-anywhere.herokuapp.com/https://api.darksky.net/forecast/a8aa053288d0f79e11f6a65e33c19366/' + \"\".concat(lat, \",\").concat(_long);\n          _context.prev = 18;\n          _context.next = 21;\n          return regeneratorRuntime.awrap(fetch(url));\n\n        case 21:\n          response = _context.sent;\n          _context.next = 24;\n          return regeneratorRuntime.awrap(response.json());\n\n        case 24:\n          data = _context.sent;\n          WeatherP = data.currently.summary.toUpperCase();\n          summaryWeatherP.innerHTML = WeatherP;\n          tempF = Math.round(data.currently.temperature);\n          tempC = fToC(tempF);\n          appTempF = Math.round(data.currently.apparentTemperature);\n          appTempC = fToC(appTempF);\n          windSpeed = windToMS(data.currently.windSpeed.toFixed(1));\n          humidity = Math.round(data.currently.humidity * 100);\n          todayWeatherIcon = data.currently.icon;\n          nextDay1WeatherIcon = data.daily.data[0].icon;\n          nextDay2WeatherIcon = data.daily.data[1].icon;\n          nextDay3WeatherIcon = data.daily.data[2].icon;\n          todayWeatherIconElement.style.background = \"url(./assets/img/\".concat(todayWeatherIcon, \".svg) no-repeat rgba(255, 255, 0, 0.1) 50% 50%\");\n          todayWeatherIconElement.style.backgroundSize = '100%';\n          nextDay1WeatherIconElement.style.background = \"url(./assets/img/\".concat(nextDay1WeatherIcon, \".svg) no-repeat rgba(255, 255, 0, 0.1) 50% 50%\");\n          nextDay1WeatherIconElement.style.backgroundSize = '100%';\n          nextDay2WeatherIconElement.style.background = \"url(./assets/img/\".concat(nextDay2WeatherIcon, \".svg) no-repeat rgba(255, 255, 0, 0.1) 50% 50%\");\n          nextDay2WeatherIconElement.style.backgroundSize = '100%';\n          nextDay3WeatherIconElement.style.background = \"url(./assets/img/\".concat(nextDay3WeatherIcon, \".svg) no-repeat rgba(255, 255, 0, 0.1) 50% 50%\");\n          nextDay3WeatherIconElement.style.backgroundSize = '100%';\n          nextDay1Temp = fToC((data.daily.data[0].temperatureHigh + data.daily.data[0].temperatureLow) / 2);\n          nextDay2Temp = fToC((data.daily.data[1].temperatureHigh + data.daily.data[1].temperatureLow) / 2);\n          nextDay3Temp = fToC((data.daily.data[2].temperatureHigh + data.daily.data[2].temperatureLow) / 2);\n          today = new Date(data.currently.time * 1000);\n          nextDay1 = new Date((data.currently.time + 86400) * 1000);\n          nextDay2 = new Date((data.currently.time + 172800) * 1000);\n          nextDay3 = new Date((data.currently.time + 259200) * 1000);\n          currTimeStr = today.toLocaleString('en-US', {\n            weekday: 'short',\n            day: 'numeric',\n            month: 'long',\n            hour: 'numeric',\n            minute: 'numeric',\n            hour12: false,\n            timeZone: data.timezone\n          });\n          currTime = currTimeStr.replace(/\\,/g, '');\n          nextWeekDay1 = nextDay1.toLocaleString('en-US', {\n            weekday: 'long',\n            timeZone: data.timezone\n          });\n          nextWeekDay2 = nextDay2.toLocaleString('en-US', {\n            weekday: 'long',\n            timeZone: data.timezone\n          });\n          nextWeekDay3 = nextDay3.toLocaleString('en-US', {\n            weekday: 'long',\n            timeZone: data.timezone\n          });\n          tempSpan.innerHTML = \"\".concat(tempC, \"&#176;\");\n          appTempSpan.innerHTML = \"\".concat(appTempC, \"&#176;\");\n          windSpan.innerHTML = windSpeed;\n          humiditySpan.innerHTML = humidity;\n          todayWeatherDate.innerHTML = currTime;\n          nextDay1Span.innerHTML = nextWeekDay1;\n          nextDay2Span.innerHTML = nextWeekDay2;\n          nextDay3Span.innerHTML = nextWeekDay3;\n          nextDay1TempSpan.innerHTML = \"\".concat(nextDay1Temp, \"&#176;\");\n          nextDay2TempSpan.innerHTML = \"\".concat(nextDay2Temp, \"&#176;\");\n          nextDay3TempSpan.innerHTML = \"\".concat(nextDay3Temp, \"&#176;\");\n          _context.next = 73;\n          break;\n\n        case 70:\n          _context.prev = 70;\n          _context.t0 = _context[\"catch\"](18);\n          console.error(_context.t0);\n\n        case 73:\n        case \"end\":\n          return _context.stop();\n      }\n    }\n  }, null, null, [[18, 70]]);\n}\n\n//# sourceURL=webpack:///./src/components/functions/getWeather.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getCoordinatesFromSearch\", function() { return getCoordinatesFromSearch; });\nvar KEY = '170c2c7305f64259838058f18894a876';\nfunction getCoordinatesFromSearch(f1) {\n  var locationCoord1,\n      locationCoord2,\n      placeP,\n      cityI,\n      cityV,\n      url,\n      response,\n      data,\n      lat,\n      lng,\n      _len,\n      args,\n      _key,\n      _args = arguments;\n\n  return regeneratorRuntime.async(function getCoordinatesFromSearch$(_context) {\n    while (1) {\n      switch (_context.prev = _context.next) {\n        case 0:\n          locationCoord1 = document.querySelector('#latSpan');\n          locationCoord2 = document.querySelector('#lonSpan');\n          placeP = document.querySelector('.today-weather__place');\n          cityI = document.querySelector('#search');\n          cityV = cityI.value;\n\n          if (!(!cityV && cityV.length < 3)) {\n            _context.next = 7;\n            break;\n          }\n\n          return _context.abrupt(\"return\");\n\n        case 7:\n          url = \"https://api.opencagedata.com/geocode/v1/json?q=\".concat(cityV, \"&key=\").concat(KEY, \"&pretty=1&no_annotations=1\");\n          _context.prev = 8;\n          _context.next = 11;\n          return regeneratorRuntime.awrap(fetch(url));\n\n        case 11:\n          response = _context.sent;\n          _context.next = 14;\n          return regeneratorRuntime.awrap(response.json());\n\n        case 14:\n          data = _context.sent;\n          lat = ((data.results[0].bounds.northeast.lat + data.results[0].bounds.southwest.lat) / 2).toFixed(2);\n          lng = ((data.results[0].bounds.northeast.lng + data.results[0].bounds.southwest.lng) / 2).toFixed(2);\n          placeP.innerHTML = cityV;\n          locationCoord1.innerHTML = \"\".concat(Math.floor(lat), \"&#176;\").concat(Math.floor((lat - Math.floor(lat)) * 100), \"'\");\n          locationCoord2.innerHTML = \"\".concat(Math.floor(lng), \"&#176;\").concat(Math.floor((lng - Math.floor(lng)) * 100), \"'\");\n          f1(Number(lng), Number(lat));\n\n          for (_len = _args.length, args = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {\n            args[_key - 1] = _args[_key];\n          }\n\n          args.forEach(function (func) {\n            func(Number(lat), Number(lng));\n          });\n          _context.next = 28;\n          break;\n\n        case 25:\n          _context.prev = 25;\n          _context.t0 = _context[\"catch\"](8);\n          console.error(_context.t0);\n\n        case 28:\n          cityI.value = '';\n\n        case 29:\n        case \"end\":\n          return _context.stop();\n      }\n    }\n  }, null, null, [[8, 25]]);\n}\n\n//# sourceURL=webpack:///./src/components/functions/search.js?");
